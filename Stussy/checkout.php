...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      ?>
         ...
         <input type="hidden" id="total_price" name="total_price" value="<?= $grand_total; ?>" value="">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Baranggay :</span>
            <input type="text" name="flat" placeholder="Baranggay" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Street/Purok :</span>
         ...
         <div class="inputBox">
            <span>Province:</span>
            <input type="text" name="state" placeholder="Provine" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
      ...
      <script src="https://www.paypal.com/sdk/js?client-id=AbX6CROoJI413RquQEoUnmLvSSiglQb8ZTttI0g9YsmjD1CzBzaKc2sWi-B5chdVzHDLz07ZoXkSlcPv&currency=USD"></script>
